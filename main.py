...
TELEGRAM_BOT_TOKEN = '7217456471:AAH5l-UDcWzUT6UfHF_MTPZe5umtHXSzYqg'
TELEGRAM_CHAT_ID = '761605242'
...
cv2.namedWindow('Prisoner Monitoring', cv2.WINDOW_NORMAL)
cv2.resizeWindow('Prisoner Monitoring', 800, 600)  # Adjust the size as needed
